...
//float l3Dbins[] = {};
    ...
    hPullX = createHists<TH1F>("pullX","X pull",1000,-5,5);
    hPullY = createHists<TH1F>("pullY","Y pull",1000,-5,5);
    hPullZ = createHists<TH1F>("pullZ","Z pull",1000,-5,5);
    hPullL3D = createHists<TH1F>("pullL3D","l3D pull",1000,-5,5);
